...
image_particles = Image("particles", "images/particles.png")
image_game = Image("game", "images/game.png")
image_emoticons = Image("emoticons", "images/emoticons.png")
image_speedup_arrow = Image("speedup_arrow", "images/speed_arrow.png")
image_guibuttons = Image("guibuttons", "images/gui_buttons.png")
image_guiicons = Image("guiicons", "images/gui_icons.png")
image_arrow = Image("arrow", "images/arrow.png")
image_audio_source = Image("audio_source", "images/audio_source.png")
image_strongweak = Image("strongweak", "images/strong_weak.png")
image_hud = Image("hud", "images/hud.png")
image_extras = Image("extras", "images/extras.png")

container.images.Add(image_null)
container.images.Add(image_game)
container.images.Add(image_particles)
container.images.Add(Image("cursor", "images/gui_cursor.png"))
container.images.Add(Image("banner", "images/gui_logo.png"))
container.images.Add(image_emoticons)
container.images.Add(Image("console_bg", "images/console.png"))
container.images.Add(Image("console_bar", "images/console_bar.png"))
