...
public:
	...
	void ProceedLocalized(class CLayerTiles *pLayer, class CLayerTiles *pReference, int ConfigId, int Seed = 0, int X = 0, int Y = 0, int Width = -1, int Height = -1);
	void Proceed(class CLayerTiles *pLayer, class CLayerTiles *pReference, int ConfigId, int Seed = 0, int SeedOffsetX = 0, int SeedOffsetY = 0);
